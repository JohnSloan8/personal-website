          ...
          <div className="news_popup_informations">
            ...
            <div className="text" id="infoText">
              ...
              <div className="padding-top-lg">
                ...
                <p className="kura_tm_main_title padding-top-lg">
...
const Softwaretext = `
  Work for the ABAIR project at Trinity College Dublin. Overseeing the cloud migration of Irish speech and language technologies.
`;
            ...
            <div className="hidden_content">
              <div className="popup_informations">
                <div className="description">
                  ...
                  {title === "Software Engineering" ? Softwaretext : ``}
                </div>
              </div>
            </div>
          </div>
